        ...
        <div class="row">
            <div class="box">
                <div class="col-lg-12 text-center">
                    <div id="carouselpics" class="carousel slide">
                        <!-- Indicators -->
                        ...
                        <!-- Controls -->
                        <a class="left carousel-control" href="#carouselpics" data-slide="prev">
                            <span class="icon-prev"></span>
                        </a>
                        <a class="right carousel-control" href="#carouselpics" data-slide="next">
                    ...
                    <h1 class="brand-name">Close Quarters Scuba</h1>
