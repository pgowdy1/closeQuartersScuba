...
<body>
    ...
    <div class="container">	
		<div class="row">
			<div class="col-md-12">
				<img src="cozumel-modified.jpg" class="img-responsive" alt="Cozumel">
			</div>
		</div>
		...
		<div class="row">
			<div class="col-md-12">
				<img src="hawaii-modified.jpg" class="img-responsive" alt="Hawaii">
			</div>
		</div>
		<div class="box">
		...
		<div class="row">
			<div class="col-md-12">
				<img src="maldives-modified.jpg" class="img-responsive" alt="Cozumel">
			</div>
		</div>
		<div class="box custom1">
			<div class="row">
